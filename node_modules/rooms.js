exports.Room = function(roomSize) {
	...
	this.nextRatio = function() {
		...
		} else if(this.nextBox() < 6) {
			this.ratio = this.ratio/1.12;
		} else if(this.nextBox() < 10) {
			this.ratio = this.ratio/1.04;
		} else if(this.nextBox() < 30) {
			this.ratio = this.ratio/1.009;
		} else if(this.nextBox() < 40) {
			this.ratio = this.ratio/1.007;
		} else if(this.nextBox() < 70) {
			this.ratio = this.ratio/1.003;
		} else if(this.nextBox() < 100) {
			this.ratio = 0.2;
		} else {
			this.ratio = 0.1;
		}
